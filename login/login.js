function login(){
    ...
    ||  username == "Rubaib" && password == 1012 ||  username == "Shinas" && password == 1028 ||  username == "Fadil" && password == 1015 ||  username == "Vasil" && password == 1004
    ...
    || username == "Ikram" && password == 993){
        window.open("./stud/"+password+".html", "_blank");
    }else{
