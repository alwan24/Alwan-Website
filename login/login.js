function login(){
    ...
    || username == "Ihsan" && password == 1019 || username == "Salman" && password == 1039  || username == "Rinshad" && password == 998 || username == "Dude" && password == 0515
    || username == "Juraij" && password == 0777 || username == "Basith" && password == 970 || username == "Shidad" && password == 997 || username == "Sanih" && password == 975 
